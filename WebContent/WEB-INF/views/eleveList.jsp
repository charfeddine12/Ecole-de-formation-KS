    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h2 class="sub-header">Liste des Eleves</h2>
          <div class="table-responsive">
            <table class="table table-striped table-hover" >
              ...
              <c:forEach items="${eleves}" var="eleve">
                <tr>
               	  <td><img src="<c:url value="/resources/img/eleve/${eleve.matricule}.png"/>" alt="photo" style="width:100px;height:70px"></td>
                  <td>${eleve.matricule}</td>
                  <td>${eleve.nomEl}</td>
                  <td>${eleve.prenomEl}</td>
                  <td>${eleve.adresseEl}</td>
                  <td>${eleve.telEl}</td>
                  <td>${eleve.emailEl}</td>
                  <td>
                  <a href="<spring:url value="/eleveList/ViewEleve/${eleve.matricule}" />" >
                  <span class="glyphicon glyphicon-info-sign"></span></a>
                  <a href="<spring:url value="/eleveList/deleteEleve/${eleve.matricule}" />" >
                  <span class="glyphicon glyphicon-remove"></span></a>
                  <a href="<spring:url value="/eleveList/editEleve/${eleve.matricule}" />" >
