...
<html>
 <head>
    ...
    <title>Details d'un eleve</title>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h2 class="sub-header">Détails d'Eleve</h2>
          <div class="container">
          <div class="row">
		  <div class="col-md-5">
		  <img src="<c:url value="/resources/img/eleve/${eleve.matricule}.png"/>" alt="photo" style="width:100%;height:300px">
		  </div>
		  <div class="col-md-5">
		  <p>
		  <span class="glyphicon glyphicon-user"></span> 
		  ${eleve.nomEl} ${eleve.prenomEl}</p>
		  <p><span class="glyphicon glyphicon-home"></span> ${eleve.adresseEl}</p>
		  <p><span class="glyphicon glyphicon-earphone"></span> ${eleve.telEl}</p>
		  <p>
		  <span class="glyphicon glyphicon-envelope"></span> ${eleve.emailEl}</p>
		  </div>
