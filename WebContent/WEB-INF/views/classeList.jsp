    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h2 class="sub-header">Liste des classes</h2>
            ...
            <table class="table table-striped table-hover" >
              ...
              <c:forEach items="${classes}" var="classe">
                <tr>
                  <td>${classe.idCl}</td>
                  <td>${classe.nomCl}</td>
                  <td>${classe.niveauCl}</td>
                  
                  <td>
                  <a href="<spring:url value="/classeList/ViewClasse/${classe.idCl}" />" >
                  <span class="glyphicon glyphicon-info-sign"></span></a>
                  <a href="<spring:url value="/classeList/deleteClasse/${classe.idCl}" />" >
                  <span class="glyphicon glyphicon-remove"></span></a>
                  <a href="<spring:url value="/classeList/editClasse/${classe.idCl}" />" >
