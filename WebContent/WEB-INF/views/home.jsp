    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" style="height:60px;">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="<c:url value="/professeurList"/>"><img src="<c:url value="/resources/img/logo2.png"/>" style="height:60px;width:100px;"></a></div>
        </div>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h2 class="sub-header">Bienvenue administrateur</h2>
          <div style="font-size:200%;"><p>Cette application vous permet de:</p>
          
        <br/> 
        <ul>
        <li>Gerer la liste des professeurs.</li>
        <li>Gerer la liste des eleves.</li>
        <li>Gerer la liste des spécialité</li>
        <li>Gerer la liste des salles</li>
        <li>Gerer la liste des matieres</li>
        <li>Gerer la liste des classes</li>
        <li>Gerer la liste des Examens</li>
        </ul>
        </div>
        </div>
      </div>
