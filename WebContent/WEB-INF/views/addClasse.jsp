    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h2 class="sub-header">Ajout d'un classe</h2>
          
            <form:form name="myform1" action="${pageContext.request.contextPath }/classeList/addClasse" 
            method="post" commandName="classe" onsubmit="return validateForm();"
            enctype="multipart/form-data">
            <div class="form-group">
            <label for="nomCl">Nom</label>
            <form:input path="nomCl" id="nomCl" class="form-control" value="${classe.nomCl}"/>
            </div>
            <div class="form-group">
            <label for="niveauCl">Niveau</label>
            <form:input path="niveauCl" id="niveauCl" class="form-control" value="${classe.niveauCl}"/>
            </div>
            <br/><br/>
