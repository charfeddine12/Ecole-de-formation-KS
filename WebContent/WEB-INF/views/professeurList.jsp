          ...
          <div class="table-responsive">
            <table class="table table-striped table-hover" >
              ...
              <c:forEach items="${profs}" var="prof">
                <tr>
               	  <td><img src="<c:url value="/resources/img/${prof.idProf}.png"/>" alt="photo" style="width:100px;height:70px"></td>
                  <td>${prof.idProf}</td>
                  <td>${prof.nomProf}</td>
                  <td>${prof.prenomProf}</td>
                  <td>${prof.adresseProf}</td>
                  <td>${prof.telProf}</td>
                  <td>${prof.emailProf}</td>
                  <td>
                  <a href="<spring:url value="/professeurList/ViewProfesseur/${prof.idProf}" />" >
                  <span class="glyphicon glyphicon-info-sign"></span></a>
                  <a href="<spring:url value="/professeurList/deleteProfesseur/${prof.idProf}" />" >
                  <span class="glyphicon glyphicon-remove"></span></a>
                  <a href="<spring:url value="/professeurList/editProfesseur/${prof.idProf}" />" >
