...
<html>
 <head>
    ...
    <title>Ajout d'une specialite</title>
<script>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h2 class="sub-header">Ajout d'une specialite</h2>
          
            <form:form name="myform1" action="${pageContext.request.contextPath }/specialiteList/addSpecialite" 
            method="post" commandName="specialite" onsubmit="return validateForm();"
            enctype="multipart/form-data">
            <div class="form-group">
            <label for="libelleSpec">Libelle</label>
            <form:input path="libelleSpec" id="libelleSpec" class="form-control"/>
            </div>
            <br/><br/>
