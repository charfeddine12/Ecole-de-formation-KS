...
<html>
 <head>
    ...
    <title>Details d'un Professeur</title>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h2 class="sub-header">Détails du professeur</h2>
          <div class="container">
          <div class="row">
		  <div class="col-md-5">
		  <img src="<c:url value="/resources/img/${professeur.idProf}.png"/>" alt="photo" style="width:100%;height:300px">
		  </div>
		  <div class="col-md-5">
		  <p>
		  <span class="glyphicon glyphicon-user"></span> 
		  ${professeur.nomProf} ${professeur.prenomProf}</p>
		  <p><span class="glyphicon glyphicon-home"></span> ${professeur.adresseProf}</p>
		  <p><span class="glyphicon glyphicon-earphone"></span> ${professeur.telProf}</p>
		  <p>
		  <span class="glyphicon glyphicon-envelope"></span> ${professeur.emailProf}</p>
		  </div>
