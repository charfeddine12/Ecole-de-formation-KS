      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h2 class="sub-header">Modification d'un professeur</h2>
            ...
            <form:form name="myform" action="${pageContext.request.contextPath }/eleveList/editEleve" 
            method="post" commandName="eleve" onsubmit="return validateForm();"
            enctype="multipart/form-data">
            <form:hidden path="matricule" value="${professeur.matricule}"/>
            <div class="form-group">
            <label for="nomEl">Nom</label>
            <form:input path="nomEl" id="nomEl" class="form-control"/>
            </div>
            <div class="form-group">
            <label for="PrenomEl">Prenom</label>
            <form:input path="prenomEl" id="prenomEl" class="form-control"/>
            </div>
            <div class="form-group">
            <label for="adresseEl">Adresse</label>
            <form:input path="adresseEl" id="adresseEl" class="form-control"/>
            </div>
            <div class="form-group">
            <label for="emailEl">Email</label>
            <form:input  path="emailEl" name="email" id="emailEl" class="form-control" />
            </div>
            <div class="form-group">
            <label for="telEl">Numero de telephone</label>
            <form:input path="telEl" id="telEl" class="form-control"/>
            </div>
            <div class="form-group">
            <label class="control-label" for="imgEl">Photo</label>
            <form:input id="imgEl" path="imgEl" type="file" class="form:input-large"/>
            </div>
            <br/><br/>
            <input type="submit" value="Envoyer" class="btn btn-primary">
            <a href="<c:url value="/eleveList"/>"class="btn btn-primary">Annuler</a>
            </form:form>
