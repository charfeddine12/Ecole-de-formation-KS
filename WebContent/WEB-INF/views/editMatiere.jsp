...
<html>
 <head>
    ...
    <title>Editer une matiere</title>
<script>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h2 class="sub-header">Editer une matiere</h2>
          
            <form:form name="myform1" action="${pageContext.request.contextPath }/matiereList/editMatiere" 
            method="post" commandName="matiere" onsubmit="return validateForm();"
            enctype="multipart/form-data">
            <form:hidden path="idMat" value="${matiere.idMat}"/>
            <div class="form-group">
            <label for="nomMat">Nom</label>
            <form:input path="nomMat" id="nomMat" class="form-control" value="${matiere.nomMat}"/>
            </div>
            <div class="form-group">
            <label for="coefMat">Coefficient</label>
            <form:input path="coefMat" id="coefMat" class="form-control" value="${matiere.coefMat}"/>
            </div>
            <br/><br/>
            <input type="submit" value="Envoyer" class="btn btn-primary">
            <a href="<c:url value="/matiereList"/>"class="btn btn-primary">Annuler</a>
            </form:form>
