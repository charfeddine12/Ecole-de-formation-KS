    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h2 class="sub-header">Liste des specialites</h2>
          <div class="table-responsive">
            <table class="table table-striped table-hover" >
              ...
              <c:forEach items="${specialites}" var="specialite">
                <tr>
                  <td>${specialite.idSpec}</td>
                  <td>${specialite.libelleSpec}</td>
                  
                  
                  <td>
                  <a href="<spring:url value="/specialiteList/deleteSpecialite/${specialite.idSpec}" />" >
                  <span class="glyphicon glyphicon-remove"></span></a>
                  <a href="<spring:url value="/specialiteList/editSpecialite/${specialite.idSpec}" />" >
