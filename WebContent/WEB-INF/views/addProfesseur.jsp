    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h2 class="sub-header">Ajout d'un professeur</h2>
          
            <form:form name="myform" action="${pageContext.request.contextPath }/professeurList/addProfesseur" 
            ...
            <form:input path="prenomProf" id="prenomProf" class="form-control"/>
            </div>
            <div class="form-group">
            <label for="adresseProf">Adresse</label>
            <form:input path="adresseProf" id="adresseProf" class="form-control"/>
            </div>
            <div class="form-group">
            <label for="emailProf">Email</label>
            <form:input  path="emailProf" name="mail" id="emailProf" class="form-control" />
            </div>
            <div class="form-group">
            <label for="telProf">Numero de telephone</label>
            <form:input path="telProf" id="telProf" class="form-control"/>
            </div>
            <div class="form-group">
            ...
            <a href="<c:url value="/professeurList"/>"class="btn btn-primary">Cancel</a>
            </form:form>
