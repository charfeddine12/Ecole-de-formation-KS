    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h2 class="sub-header">Ajout d'un eleve</h2>
          
            <form:form name="myform1" action="${pageContext.request.contextPath }/eleveList/addEleve" 
            method="post" commandName="eleve" onsubmit="return validateForm();"
            enctype="multipart/form-data">
            <div class="form-group">
            <label for="nomEl">Nom</label>
            <form:input path="nomEl" id="nom" class="form-control"/>
            </div>
            <div class="form-group">
            ...
            <a href="<c:url value="/eleveList"/>"class="btn btn-primary">Cancel</a>
            </form:form>
