    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h2 class="sub-header">Modification d'un professeur</h2>
          
            <form:form name="myform" action="${pageContext.request.contextPath }/professeurList/editProfesseur" 
            method="post" commandName="professeur" onsubmit="return validateForm();"
            enctype="multipart/form-data">
            <form:hidden path="idProf" value="${professeur.idProf}"/>
            <div class="form-group">
            <label for="nomProf">Nom</label>
            <form:input path="nomProf" id="nomProf" class="form-control" value="${professeur.nomProf}"/>
            </div>
            <div class="form-group">
            <label for="Prenom">Prenom</label>
            <form:input path="prenomProf" id="prenomProf" class="form-control" value="${professeur.prenomProf}"/>
            </div>
            <div class="form-group">
            <label for="adresseProf">Adresse</label>
            <form:input path="adresseProf" id="adresseProf" class="form-control" value="${professeur.adresseProf}"/>
            </div>
            <div class="form-group">
            <label for="emailProf">Email</label>
            <form:input  path="emailProf" name="mail" id="emailProf" class="form-control" value="${professeur.emailProf}" />
            </div>
            <div class="form-group">
            <label for="telProf">Numero de telephone</label>
            <form:input path="telProf" id="telProf" class="form-control" value="${professeur.telProf}"/>
            </div>
            <div class="form-group">
            <label class="control-label" for="imgProf">Photo</label>
            <form:input id="imgProf" path="imgProf" type="file" class="form:input-large"/>
            </div>
            <br/><br/>
            <input type="submit" value="Envoyer" class="btn btn-primary">
            <a href="<c:url value="/professeurList"/>"class="btn btn-primary">Annuler</a>
            </form:form>
