    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h2 class="sub-header">Ajout d'un Examen</h2>
          
            <form:form name="myform1" action="${pageContext.request.contextPath }/examenList/addExamen" 
            ...
            <a href="<c:url value="/examenList"/>"class="btn btn-primary">Cancel</a>
            </form:form>
