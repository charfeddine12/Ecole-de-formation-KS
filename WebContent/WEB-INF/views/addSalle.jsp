    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h2 class="sub-header">Ajout d'une salle</h2>
          
            <form:form name="myform1" action="${pageContext.request.contextPath }/salleList/addSalle" 
            method="post" commandName="salle" onsubmit="return validateForm();"
            enctype="multipart/form-data">
            <div class="form-group">
            <label for="nomMat">Nom</label>
            <form:input path="nomSalle" id="nomSalle" class="form-control"/>
            </div>
            <div class="form-group">
            <label for="formeSalle">Forme</label>
            <form:input path="formeSalle" id="formeSalle" class="form-control"/>
            </div>
            <br/><br/>
