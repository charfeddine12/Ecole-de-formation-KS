...
<html>
 <head>
    ...
    <title>Editer une specialite</title>
<script>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h2 class="sub-header">Editer une specialite</h2>
          
            <form:form name="myform1" action="${pageContext.request.contextPath }/specialiteList/editSpecialite" 
            method="post" commandName="specialite" onsubmit="return validateForm();"
            enctype="multipart/form-data">
            <form:hidden path="idSpec" value="${specialite.idSpec}"/>
            <div class="form-group">
            <label for="libelleSpec">Libelle</label>
            <form:input path="libelleSpec" id="libelleSpec" value="${specialite.libelleSpec}" class="form-control"/>
            </div>
            <br/><br/>
            <input type="submit" value="Envoyer" class="btn btn-primary">
            <a href="<c:url value="/specialiteList"/>"class="btn btn-primary">Annuler</a>
            </form:form>
