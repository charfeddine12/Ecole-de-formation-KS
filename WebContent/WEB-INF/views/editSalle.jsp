    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h2 class="sub-header">Editer une salle</h2>
          
            <form:form name="myform1" action="${pageContext.request.contextPath }/salleList/editSalle" 
            method="post" commandName="salle" onsubmit="return validateForm();"
            enctype="multipart/form-data">
            <form:hidden path="idSalle" value="${salle.idSalle}"/>
            <div class="form-group">
            <label for="nomMat">Nom</label>
            <form:input path="nomSalle" id="nomSalle" class="form-control" value="${salle.nomSalle}"/>
            </div>
            <div class="form-group">
            <label for="formeSalle">Forme</label>
            <form:input path="formeSalle" id="formeSalle" class="form-control" value="${salle.formeSalle}"/>
            </div>
            <br/><br/>
            <input type="submit" value="Envoyer" class="btn btn-primary">
            <a href="<c:url value="/salleList"/>"class="btn btn-primary">Annuler</a>
            </form:form>
